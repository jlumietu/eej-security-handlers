...
public abstract class BaseSecurityFilter implements Filter {
	...
	protected void unsuccessfulAuthentication(HttpServletRequest request,
		...
		if (logger.isDebugEnabled()) {
			...
			logger.debug("Delegating to authentication failure handler " + this.authenticationFailureHandler);
		}
	...
	@Override
	public void destroy() {
		logger.debug("Destroy filter " + this.getClass().getName());
	}
	...
	public void init(FilterConfig arg0) throws ServletException {
		logger.debug("Init filter " + this.getClass().getName());
	}	
